...
export const TerminoForm = () => {
  return (
    <div className="container">
      {/* Encabezado */}
      <div className="p-8 bg-primary-50 border-b border-primary-100">
        <div className="flex flex-col md:flex-row items-center gap-4">
          <Smile className="w-12 h-12 text-emerald-500 animate-pulse" />
          <div>
            <h1 className="text-2xl font-medium text-gray-800">
              ¡Gracias por tu opinión!
            </h1>
            <p className="text-primary-600">Encuesta de satisfacción</p>
          </div>
        </div>
      </div>
